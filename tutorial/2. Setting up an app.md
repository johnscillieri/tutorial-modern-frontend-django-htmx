...
In the last step, you made a Django Project. Now you'll make an app inside that project. 
...
Learn more about url configuration here: https://docs.djangoproject.com/en/5.1/topics/http/urls/ 
