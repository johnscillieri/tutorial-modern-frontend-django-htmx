...
Let's see what happens if we return a blank response.  What do you think will happen?
...
This is happening because of a lack of CSRF token in the request. Remember how we added the token to the form as a hidden input? 

GET requests do not need a CSRF token. Everything else does. 
